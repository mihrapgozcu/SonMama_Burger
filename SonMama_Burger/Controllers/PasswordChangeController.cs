...
namespace SonMama_Burger.Controllers
{
    public class PasswordChangeController : Controller
    {
        ...
        public void SendEmail(string email, string passwordResetTokenLink)
        {
            ...
            MailboxAddress mailboxAddressFrom = new MailboxAddress("HamburgerProjesi Admin", "projemama@gmail.com");
            ...
            client.Authenticate("projemama@gmail.com", "wvgdopwbgegdlgcl");
